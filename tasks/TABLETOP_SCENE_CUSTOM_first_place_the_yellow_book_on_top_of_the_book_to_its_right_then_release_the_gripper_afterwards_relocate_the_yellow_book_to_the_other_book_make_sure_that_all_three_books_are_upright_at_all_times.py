...
def main():
    ...
    language = "First place the yellow book on top of the book to its right, then release the gripper. Afterwards, relocate the yellow book to the other book. Make sure that all three books are upright at all times"
    register_task_info(
        language,
    ...
    "black_book_2"
        ...
        ("ConstraintAlways", ("Or", ("AxisAlignedWithin", "yellow_book_1", "z", 0, 5), ("AxisAlignedWithin", "yellow_book_1", "z", 0, 5))),
        ("ConstraintAlways", ("Or", ("AxisAlignedWithin", "black_book_2", "z", 0, 5), ("AxisAlignedWithin", "black_book_2", "z", 0, 5))),
        ("ConstraintAlways", ("Or", ("AxisAlignedWithin", "black_book_1", "z", 0, 5), ("AxisAlignedWithin", "black_book_1", "z", 0, 5))),
    ]
    )
