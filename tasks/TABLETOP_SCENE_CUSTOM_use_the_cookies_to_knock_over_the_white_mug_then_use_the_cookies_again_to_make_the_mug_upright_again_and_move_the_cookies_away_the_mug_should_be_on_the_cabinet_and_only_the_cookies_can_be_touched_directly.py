...
def main():
    ...
    language = "Use the cookies to knock over the white mug. Then use the cookies again to make the mug upright again and move the cookies away. The mug should be on the cabinet and only the cookies can be touched directly."
    ...
    "wooden_cabinet_1"
        ...
        ("Sequential", (
            ...
            ("InContact", "cookies_1", "porcelain_mug_1"),
            ("Or", ("AxisAlignedWithin", "porcelain_mug_1", "z", 0, 5), ("AxisAlignedWithin", "porcelain_mug_1", "z", 0, 5)),
            ("Not", ("InContact", "cookies_1", "porcelain_mug_1")),
        )),
        ("All",
            tuple(never_preds)
        ),   
        ("InContact", "porcelain_mug_1", "wooden_cabinet_1"),
    ]
    )
