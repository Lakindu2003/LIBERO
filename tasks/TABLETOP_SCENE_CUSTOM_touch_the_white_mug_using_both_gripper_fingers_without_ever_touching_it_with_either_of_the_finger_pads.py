...
def main():
    ...
    language = "Touch the white mug using both gripper fingers without ever touching it with either of the finger pads."
    register_task_info(
        language,
    ...
    "porcelain_mug_1"
        ...
        goal_states=[
        ("ConstraintOnce", ("InContact", "gripper0_finger1", "porcelain_mug_1")),
        ("ConstraintOnce", ("InContact", "gripper0_finger2", "porcelain_mug_1")),
