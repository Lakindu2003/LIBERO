...
def main():
    ...
    language = "Touch the left black book and then the plate without touching anything else"

    keep = {"black_book_centered_2", "plate_1"}

    # all movable & fixture objects in your scene
    all_objs = {
        "black_book_centered_1",
        "black_book_centered_2",
        "yellow_book_1",
        "white_storage_box_1",
        "red_coffee_mug_1",
        "porcelain_mug_1",
    ...
    "plate_1"
        ...
        ("Sequential", (
            ("Any", (
                ("InContact", "gripper0_finger1", "black_book_centered_2"),
                ("InContact", "gripper0_finger2", "black_book_centered_2"),
                ("InContact", "gripper0_hand", "black_book_centered_2"),
                ("InContact", "gripper0_finger1_pad", "black_book_centered_2"),
                ("InContact", "gripper0_finger2_pad", "black_book_centered_2"),
            )),
            ("Any", (
                ("InContact", "gripper0_finger1", "plate_1"),
                ("InContact", "gripper0_finger2", "plate_1"),
                ("InContact", "gripper0_hand", "plate_1"),
