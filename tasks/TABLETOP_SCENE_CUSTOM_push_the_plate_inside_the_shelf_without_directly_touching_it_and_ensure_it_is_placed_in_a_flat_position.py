...
def main():
    ...
    language = "Push the plate inside the shelf without directly touching it and ensure it is placed in a flat position"
    register_task_info(
        language,
    ...
    "wooden_shelf_1"
        ...
        ("Or", ("AxisAlignedWithin", "plate_1", "z", 0, 5), ("AxisAlignedWithin", "plate_1", "z", 175, 180)),
        ("All", (
                ("ConstraintNever", ("InContact", "plate_1", "gripper0_finger1")),
                ("ConstraintNever", ("InContact", "plate_1", "gripper0_finger2")),
                ("ConstraintNever", ("InContact", "plate_1", "gripper0_finger1_pad")),
                ("ConstraintNever", ("InContact", "plate_1", "gripper0_finger2_pad")),
                ("ConstraintNever", ("InContact", "plate_1", "gripper0_hand")),
            )),
    ]
    )
