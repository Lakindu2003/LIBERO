...
def main():
    ...
    language = "Place the gripper head to be in between the two mugs horizontally making contact with them"
    register_task_info(
        language,
    ...
    "porcelain_mug_1"
        ...
        goal_states=[
        ("MidBetween", "red_coffee_mug_1", "gripper0_hand", "porcelain_mug_1", "y"),
    ]
    )
