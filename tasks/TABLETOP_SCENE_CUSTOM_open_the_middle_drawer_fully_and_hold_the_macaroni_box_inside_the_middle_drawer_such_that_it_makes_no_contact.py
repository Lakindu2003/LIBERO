...
def main():
    ...
    language = "Open the middle drawer fully, and hold the macaroni box inside the middle drawer such that it makes no contact"
    register_task_info(
        language,
    ...
    "wooden_cabinet_1"
        ...
        goal_states=[
        ("OpenRatio", "wooden_cabinet_1_middle_region", 1.0),
        ("RelaxedIn", "macaroni_and_cheese_1", "wooden_cabinet_1_middle_region"),
        ("Not", ("InContact", "macaroni_and_cheese_1", "wooden_cabinet_1"))
    ]
    )
