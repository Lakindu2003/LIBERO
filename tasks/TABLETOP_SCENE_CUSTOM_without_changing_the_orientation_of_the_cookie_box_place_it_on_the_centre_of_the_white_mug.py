...
def main():
    ...
    language = "Without changing the orientation of the cookie box place it on the centre of the white mug"
    register_task_info(
        language,
    ...
    "porcelain_mug_1"
        ...
        goal_states=[
        ("On", "cookies_1", "porcelain_mug_1"),
        ("ConstraintAlways", ("AxisAlignedWithin", "cookies_1", "z", 0, 2),),
    ]
    )
