...
def main():
    ...
    language = "Use the macaroni box to topple the milk carton, then place it inside or on top of the centre of the white box without directly touching the carton or the white box"
    register_task_info(
        language,
    ...
    "white_storage_box_1"
        ...
        ("Sequential", (
            ...
            ("On", "milk_1", "white_storage_box_1"),
        )),
        ("All", (
        ("ConstraintNever", ("InContact", "milk_1", "gripper0_hand")),
        ("ConstraintNever", ("InContact", "milk_1", "gripper0_finger1")),
        ("ConstraintNever", ("InContact", "milk_1", "gripper0_finger2")),
        ("ConstraintNever", ("InContact", "milk_1", "gripper0_finger1_pad")),
        ("ConstraintNever", ("InContact", "milk_1", "gripper0_finger2_pad")),
        ("ConstraintNever", ("InContact", "white_storage_box_1", "gripper0_hand")),
        ("ConstraintNever", ("InContact", "white_storage_box_1", "gripper0_finger1")),
        ("ConstraintNever", ("InContact", "white_storage_box_1", "gripper0_finger2")),
        ("ConstraintNever", ("InContact", "white_storage_box_1", "gripper0_finger1_pad")),
        ("ConstraintNever", ("InContact", "white_storage_box_1", "gripper0_finger2_pad")),
        )),
    ]
    )
