...
def main():
    ...
    language = "First place the milk carton on top of the right black book, then the macaroni on top of the yellow book and finally the remaining food item on the remaining book."
    register_task_info(
        language,
    ...
    "black_book_1"
        ...
        ("Sequential", (
            ("All", (
                ("RelaxedOn", "milk_1", "black_book_1"),
                ("Not", ("InContact", "milk_1", "gripper0_finger1")),
                ("Not", ("InContact", "milk_1", "gripper0_finger2")),
                ("Not", ("InContact", "milk_1", "gripper0_finger1_pad")),
                ("Not", ("InContact", "milk_1", "gripper0_finger2_pad")),
                ("Not", ("InContact", "milk_1", "gripper0_hand")),
            )),
            ("All", (
                ("RelaxedOn", "macaroni_and_cheese_1", "yellow_book_1"),
                ("Not", ("InContact", "macaroni_and_cheese_1", "gripper0_finger1")),
                ("Not", ("InContact", "macaroni_and_cheese_1", "gripper0_finger2")),
                ("Not", ("InContact", "macaroni_and_cheese_1", "gripper0_finger1_pad")),
                ("Not", ("InContact", "macaroni_and_cheese_1", "gripper0_finger2_pad")),
                ("Not", ("InContact", "macaroni_and_cheese_1", "gripper0_hand")),
            )),
            ("All", (
                ("RelaxedOn", "cookies_1", "black_book_2"),
                ("Not", ("InContact", "cookies_1", "gripper0_finger1")),
                ("Not", ("InContact", "cookies_1", "gripper0_finger2")),
                ("Not", ("InContact", "cookies_1", "gripper0_finger1_pad")),
                ("Not", ("InContact", "cookies_1", "gripper0_finger2_pad")),
                ("Not", ("InContact", "cookies_1", "gripper0_hand")),
            )),
        )),
    ]
    )
