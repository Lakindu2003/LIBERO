...
def main():
    ...
    language = "Place the gripper in the horizontal mid point between the centres of the microwave and cabinet"
    register_task_info(
        language,
    ...
    "wooden_cabinet_1"
        ...
        goal_states=[
        ("equal", ("PlanarDistance", "microwave_1", "gripper0_hand"), ("distance", "wooden_cabinet_1", "gripper0_hand"), 0.05),
    ]
    )
