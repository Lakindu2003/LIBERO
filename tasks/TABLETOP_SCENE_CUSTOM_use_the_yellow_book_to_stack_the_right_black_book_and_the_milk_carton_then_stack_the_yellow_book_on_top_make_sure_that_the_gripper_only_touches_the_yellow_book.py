...
def main():
    ...
    language = "Use the yellow book to stack the milk carton on the right black book. Then stack the yellow book on top. Make sure that the gripper only touches the yellow book."

    keep = {"yellow_book_1"}

    # all movable & fixture objects in your scene
    all_objs = {
        "black_book_1",
        "black_book_2",
        "yellow_book_1",
        ...
        "wooden_shelf_1",
        "wooden_cabinet_1",
        # if you want to forbid touching the table itself:
        # "main_table"
    }

    # gripper parts that can contact things
    gripper_parts = [
        "gripper0_finger1",
        "gripper0_finger2",
        "gripper0_hand",
        "gripper0_finger1_pad",
        "gripper0_finger2_pad",
    ]

    # build the list of ConstraintNever predicates
    never_preds = []
    for part in gripper_parts:
        for obj in all_objs - keep:
            never_preds.append(
                ("ConstraintNever", ("InContact", part, obj))
            )
    ...
    "yellow_book_1"
        ...
        ("RelaxedOn", "yellow_book_1", "milk_1"),
        ("All", (
            ("Not", ("InContact", "yellow_book_1", "gripper0_finger1_pad")),
            ("Not", ("InContact", "yellow_book_1", "gripper0_finger2_pad")),
            ("Not", ("InContact", "yellow_book_1", "gripper0_finger1")),
            ("Not", ("InContact", "yellow_book_1", "gripper0_finger2")),
            ("Not", ("InContact", "yellow_book_1", "gripper0_hand")),
