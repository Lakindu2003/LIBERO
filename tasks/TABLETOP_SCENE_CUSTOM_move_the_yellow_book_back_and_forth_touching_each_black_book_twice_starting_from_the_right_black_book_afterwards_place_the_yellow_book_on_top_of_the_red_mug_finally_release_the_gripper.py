...
def main():
    ...
    language = "Move the yellow book back and forth touching each black book twice starting from the right black book. Afterwards, place the yellow book on the centre of the red mug. Finally, release the gripper."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
    "yellow_book_centered_1",
    "red_coffee_mug_1"
],
        goal_states=[
            ("Sequential", (
                ("InContact", "black_book_centered_1", "yellow_book_centered_1"),
                ("InContact", "black_book_centered_2", "yellow_book_centered_1"),
                ("InContact", "black_book_centered_1", "yellow_book_centered_1"),
                ("InContact", "black_book_centered_2", "yellow_book_centered_1"),
                ("On", "yellow_book_centered_1", "red_coffee_mug_1"),
            )),
            ("Not", ("InContact", "gripper0_hand", "yellow_book_centered_1")),
            ("Not", ("InContact", "gripper0_finger1", "yellow_book_centered_1")),
            ("Not", ("InContact", "gripper0_finger2", "yellow_book_centered_1")),
            ("Not", ("InContact", "gripper0_finger1_pad", "yellow_book_centered_1")),
            ("Not", ("InContact", "gripper0_finger2_pad", "yellow_book_centered_1")),
    ]
    )
