...
class TabletopSceneCustom(InitialSceneTemplates):
    ...
    def init_states(self):
        states = [
            ...
            ("On", "cookies_1", "black_book_centered_1"),
...
def main():
    ...
    language = "By only making contact with the cookie box, place it in between the milk and macaroni boxes horizontally"
    ...
    "macaroni_and_cheese_1"
        ...
        goal_states=[
        ("RelaxedMidBetween", "milk_1", "cookies_1", "macaroni_and_cheese_1", "y"),
