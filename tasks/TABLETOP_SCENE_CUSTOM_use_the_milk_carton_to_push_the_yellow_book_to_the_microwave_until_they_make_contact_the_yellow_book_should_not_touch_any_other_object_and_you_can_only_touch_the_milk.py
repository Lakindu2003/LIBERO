...
def main():
    ...
    language = "Use the milk carton to push the yellow book to the microwave until they make contact. The yellow book should not touch any other object and you can only touch the milk"
    ...
    for obj in all_objs - keep - {"yellow_book_1", "microwave_1"}:
        never_preds.append(
            ("ConstraintNever", ("InContact", "yellow_book_1", obj))
        )
