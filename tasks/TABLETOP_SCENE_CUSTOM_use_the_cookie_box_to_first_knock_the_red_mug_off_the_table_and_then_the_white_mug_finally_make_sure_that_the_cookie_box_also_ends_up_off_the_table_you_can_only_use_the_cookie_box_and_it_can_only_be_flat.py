...
def main():
    ...
    language = "Use the cookie box to first knock the red mug off the table and then the white mug. Finally make sure that the cookie box also end up off the table. You can only the cookie box and it can only be flat."
    ...
    "porcelain_mug_1"
        ...
        goal_states=[
        ("Sequential", (
            ("InContact", "cookies_1", "red_coffee_mug_1"),
            ("PosiLessThan", "red_coffee_mug_1", "z", 0.85),
            ("InContact", "cookies_1", "porcelain_mug_1"),
            ("PosiLessThan", "porcelain_mug_1", "z", 0.85),
            ("PosiLessThan", "cookies_1", "z", 0.85),
        )),
        ("ConstraintAlways", ("Or", ("AxisAlignedWithin", "cookies_1", "z", 0, 10), ("AxisAlignedWithin", "cookies_1", "z", 170, 180)),),
        ("All",
            tuple(never_preds)
        ),        
    ]
