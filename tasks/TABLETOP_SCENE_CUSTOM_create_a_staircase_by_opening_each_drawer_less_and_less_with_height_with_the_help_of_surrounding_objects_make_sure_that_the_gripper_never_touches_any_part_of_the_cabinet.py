...
def main():
    ...
    language = "Create a staircase by opening each drawer less and less with height with the help of surrounding objects. Make sure that the gripper never touches any part of the cabinet."
    register_task_info(
        language,
    ...
    "wooden_cabinet_1"
        ...
        ("All", (
            ("ConstraintNever", ("InContact", "gripper0_hand", "wooden_cabinet_1")),
            ("ConstraintNever", ("InContact", "gripper0_finger1", "wooden_cabinet_1")),
            ("ConstraintNever", ("InContact", "gripper0_finger2", "wooden_cabinet_1")),
            ("ConstraintNever", ("InContact", "gripper0_finger1_pad", "wooden_cabinet_1")),
            ("ConstraintNever", ("InContact", "gripper0_finger2_pad", "wooden_cabinet_1")),
        )),
    ]
    )
